...
![Connected](docs/images/system-card-connected.png)
![Disconnected](docs/images/system-card-disconnected.png)
![Unreachable](docs/images/system-card-unreachable.png)
