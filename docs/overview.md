...
![Connected system card](docs/images/system-card-connected.png)
![Disconnected system card](docs/images/system-card-disconnected.png)
![Unreachable system card](docs/images/system-card-unreachable.png)
...
![Add System dialog](docs/images/add-system-dialog.png)
