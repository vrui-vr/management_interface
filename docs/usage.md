...
![System card — connected](docs/images/system-card-connected.png)
...
![Edit system menu](docs/images/edit-system-menu.png)
...
![Device controls](docs/images/device-controls.png)
